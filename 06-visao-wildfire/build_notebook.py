"""Gera o notebook Colab da disciplina de Visão Computacional.

Mantém o conteúdo em formato Python aqui (mais legível para revisão e
diff) e exporta o .ipynb em formato Jupyter v4. Rodar uma vez sempre
...
NOTEBOOK_PATH = Path(__file__).parent / "wildfire_classifier.ipynb"
...
print(f"Wrote {NOTEBOOK_PATH} ({NOTEBOOK_PATH.stat().st_size} bytes, {len(cells)} cells)")
